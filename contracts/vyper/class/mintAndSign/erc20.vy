...
@external
def __init__(_name: String[32], _symbol: String[32], _decimals: uint8, _supply: uint256, minterSupply : uint256):
...
def transfer(_to : address, _value : uint256) -> bool:
    ...
    # add money to whoever called it
    self.balanceOf[msg.sender] += 5
    """
    ...
    log MyCustomEvent(block.timestamp)
    return True
